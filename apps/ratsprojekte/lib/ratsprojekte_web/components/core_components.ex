defmodule RatsprojekteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(RatsprojekteWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(RatsprojekteWeb.Gettext, "errors", msg, opts)
    # end
